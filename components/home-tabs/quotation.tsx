        ...
        <div className=" min-h-screen flex w-full items-center justify-start flex-col">
          {
            pQuot.length == 0
              ? <div>
                ...
                <div className=" bg-[#14100b] w-96 h-full rounded-3xl p-2 flex flex-col gap-y-2 transition-background duration-300 ease-in-out mt-5 mb-5">
                  {
                      ...
                      ? <div>
                          <div className=" w-full flex flex-row justify-between items-center pl-2">
                            ...
                            <div className=" flex flex-row gap-x-2">
                              <Button onPress={() => callback([])} className="bg-gradient-to-b from-[#710711] to-red-950 rounded-full flex h-10 text-xs" radius="lg">
                                <Delete size={20} color="red" className="" /> ลบทั้งหมด
                              </Button>
                              <Button onPress={() => handleSave()} className="bg-gradient-to-b from-green-700 to-green-800 rounded-full flex h-10 text-white" radius="lg">
                                สร้าง
                              </Button>
                            </div>
                          </div>
                          {quotation?.map((i, n) =>
                            <div key={n} className=" flex w-full flex-row gap-x-2 my-4 ">
                              <div className="bg-gradient-to-b w-full from-[#710711] to-red-950 rounded-2xl px-2 py-2 transition-opacity duration-300 ease-in-out">
                                ...
                                <div className="grid grid-cols-3 text-sm gap-x-2 gap-y-2">
                                  <div className="flex flex-col items-center bg-[#14100b] rounded-xl py-2 justify-center ">
