  ...
  return (
    <section className="flex flex-col items-center justify-center gap-4">
      ...
      <div className=" flex flex-col mx-4 items-center">
        <div className="inline-block max-w-xl text-center justify-center my-5">
      ...
      <div className=" flex w-full text-center flex-col justify-center rounded-2xl py-2 px-5  bg-[#14100b] my-2 ">
        <span className=" font-bold text-2xl bg-gradient-to-b from-yellow-300 to-yellow-900 bg-clip-text text-transparent mb-3 mt-1 ">ทองคำเเท่ง 96.5%</span>
