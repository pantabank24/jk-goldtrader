...
export default function Home() {
  ...
  const blogs = [
    ...
    },
    {
      ...
      author_img: "/images/jk.jpg",
      author_name: "จ่าคิง ปากพนัง",
      description: "🟢 วิธีคำนวนราคาทอง 🟢 \n(ราคาทองวันนี้ + ส่วนต่างที่ทางร้านให้) x 0.0656 x (% ทองจริง x น้ำหนักทอง) = ราคาทองที่จะได้รับ \nอิงราคาทองที่ 44,000 บาท +1,350 ต่อบาท \n✅ ทองหลอมแท่ง 99.5% ได้กรัมละ 2,960 บาท+1,200 ต่อบาท \n✅ ทองหลอมแท่ง 95.0% ได้กรัมละ 2,817 บาท +1,100 ต่อบาท \n✅ ทองหลอมแท่ง 81.0% ได้กรัมละ 2,396 บาท +1,000 ต่อบาท \n✅ทองหลอมแท่ง 71.0% ได้กรัมละ 2,096 บาท \n✅ กรอบทอง ตลับทอง ไม่หลอม ทุกสภาพ ฉีกขาด ชำรุด ได้ราคาเท่ากันกับสภาพดี เช็คได้ไม่ถึง 80% บวกเพิ่มทุกชิ้น แล้วแต่กรณี ชิ้นละ 1-5%  \n🟨เหรียญ ทองคำทุกประเภท +2.5%  \n🟨 รูปหล่อ ทองคำทุกประเภท +2.0% \n🟨 พระกริ่ง ทองคำทุกประเภท คิดตามจริงไม่หัก \nอย่าคิดว่านี่คือส่วนต่างเพียงเล็กน้อย หากท่านขายหลายๆครั้ง มันจะเป็นส่วนต่างที่ยิ่งใหญ่ครับ … ไปที่ไหนไม่ถึง มาหาผม ผมรับจบให้ครับ \n\nหน้าร้านอยู่ที่ลาดพร้าว 129 ไม่สะดวกมา โทรมาปรึกษากัน แล้วส่งพัสดุมาได้ ทางร้านยินดีดูแลให้ครับ",
      img: "/images/jk-chilling.png",
      created_at: "2025-05-11"
    }
  ]
        ...
        <div className={` grid items-start justify-center gap-x-4 gap-y-5 grid-cols-2 max-md:grid-cols-1` }>
         {
          blogs.map((i, index) => (
            <div key={index} className=" flex flex-col rounded-2xl border-yellow-600 border-2 bg-[#14100b] w-96  ">
              ...
              <Button className=" mx-5 mb-5 bg-yellow-600  font-bold" onPress={()=> handleSetBlog(index)}>อ่านเพิ่มเติม</Button>
            </div>
            )
          )
         }
