...
export default function EComNavBar() {
  return (
    <Navbar isBordered className=" bg-[#710711]/80 backdrop-blur-lg shadow-lg">
      <NavbarBrand>
        <img 
      ...
      <NavbarContent className="hidden sm:flex gap-4" justify="center">
        ...
        <NavbarItem isActive>
          <Link className="bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text text-transparent" href="#">
            ขายทอง
          </Link>
        </NavbarItem>
        <NavbarItem >
